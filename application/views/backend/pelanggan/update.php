                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input id="name" class="form-control" type="text" name="email_pelanggan" value="<?= $pelanggan['email_pelanggan']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input id="no_hp" class="form-control" type="text" name="no_hp" value="<?= $pelanggan['no_hp']; ?>">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="row">
                                    <div class="col-sm-3">
                                        <img src="<?= base_url('assets/images/profile/') . $pelanggan['images']; ?>" class="img-thumbnail">
                                    </div>
                                    <div class="col-sm-5">
