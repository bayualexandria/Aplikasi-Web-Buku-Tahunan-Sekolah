<div class="container" style="margin-top: 15rem;">
    <div class="row justify-content-center" style="min-height: 20rem;">
        ...
        <?php $id = $user['id'];
        $query = "SELECT * FROM `tbl_pemesanan` WHERE `tbl_pemesanan`.`id_pelanggan`=$id ORDER BY `tbl_pemesanan`.`id` DESC LIMIT 1 ";
        $transfer = $this->db->query($query)->row_array(); ?>
                ...
                <div class="container" style="margin:10px auto;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="float-right">
                            <a href="<?= base_url('Pemesanan/bukti_upload/' . $transfer['id']); ?>" class="btn btn-info lanjut">Lanjutkan</a>
                        </div>
                    </div>
                </div>
            </div>
