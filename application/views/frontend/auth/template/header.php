...
<body>
    <header class="bg-dark" style="margin-top:-1rem;margin-bottom:-2rem;">
        <div class="container">
            <div class="logo">
                <a href="<?= base_url('website'); ?>"><img src="<?= base_url('assets/images/profile/azhar.png'); ?>" style="width:8rem;" alt="" /></a>
            </div>
            <div class="menu">
                <ul>
